...
1. Midea has closed the server-side Token APIs in Meiju Cloud and Smarthome Cloud, and we have switch to NetHome Plus cloud Token APIs to add new devices, but these Token API service are expected to be closed successively, which will prevent adding new devices in the future.
...
please check your device documents and supported feature in below table links.
